...
function Transaction() {
  ...
  const [region, setRegion] = useState("EAP")
    ...
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <select className="form-control" id="region-register" name="region" value={region.value} onChange={e => setRegion(e.target.value)}>
            {regions.map(region => (
